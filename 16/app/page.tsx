  ...
  return (
    <Shell active="home">
        ...
        <div className="bg-white border border-black shadow-card px-4 py-3">
          ...
          <ul className="list-none space-y-2 mt-3 border-t border-divider pt-3">
            <li className="flex gap-2 text-xs">
              ...
              <span>
                <SubLink href="/projects/skills-dev" label="Skills.dev" />{" "}
            ...
            <li className="flex gap-2 text-xs">
              <span className="size-[6px] bg-gray-900 rounded-sm mt-1.5 shrink-0" />
              <span>
                <SubLink href="/projects/keychains-dev" label="Keychains.dev" />{" "}
                <span className="text-muted-foreground">
            ...
            <li className="flex gap-2 text-xs">
              <span className="size-[6px] bg-gray-900 rounded-sm mt-1.5 shrink-0" />
              <span>
                <SubLink href="/projects/interagentic" label="Interagentic.inc" />{" "}
                <span className="text-muted-foreground">
                  — a network of infrastructure services made for AI agents.
                </span>
              </span>
            </li>
            <li className="flex gap-2 text-xs">
              <span className="size-[6px] bg-gray-900 rounded-sm mt-1.5 shrink-0" />
              <span>
                <SubLink href="/projects/botparty" label="Botparty.club" />{" "}
                <span className="text-muted-foreground">
      ...
      >
        ...
        >
          ...
          <div className="flex items-baseline gap-1.5 justify-between">
            <div className="text-sm truncate font-semibold leading-5">
              Lima — liquid storage, no sync, private by design
            </div>
            <div className="text-xs text-muted-foreground shrink-0 ml-1">
              2011 — 2019
            </div>
          ...
          <p className="text-xs text-muted-foreground">
            Redesigned file storage from the ground up. 6th biggest Kickstarter
            tech campaign of 2013. Solo-founder first, then co-founder &amp; CEO
            for 8 years.
          </p>
        </Link>
        ...
        <Link
          href="/projects/seafront"
          className="relative flex flex-col gap-1 px-3 py-2 ml-6 group cursor-pointer hover:bg-background-hover transition-colors"
        >
          <div className="absolute size-[7px] bg-gray-900 rounded-sm -left-[37px] top-[15px] outline outline-2 outline-background" />
          <div className="flex items-baseline gap-1.5 justify-between">
            <div className="text-xs font-semibold leading-5">
      ...
      <div className="flex flex-wrap gap-3">
        {[
          { href: "mailto:hello@severin-marcombes.fr", label: "✉️ Email" },
